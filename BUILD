...
NODEJS = {
    ...
    "{REGISTRY}/{PROJECT_ID}/nodejs-debian11:latest": "//nodejs:nodejs18_amd64_debian11",
    "{REGISTRY}/{PROJECT_ID}/nodejs-debian11:debug": "//nodejs:nodejs18_debug_amd64_debian11",
