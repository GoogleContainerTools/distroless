...
container_bundle(
    ...
    images = {
        ...
        "gcr.io/{PROJECT_ID}/python3:latest": "//experimental/python3:python3_debian9",
        "gcr.io/{PROJECT_ID}/python3:nonroot": "//experimental/python3:python3_nonroot_debian9",
        "gcr.io/{PROJECT_ID}/python3:debug": "//experimental/python3:debug_debian9",
        "gcr.io/{PROJECT_ID}/python3:debug-nonroot": "//experimental/python3:debug_nonroot_debian9",
        "gcr.io/{PROJECT_ID}/python2.7:latest": "//experimental/python2.7:python27_debian9",
        "gcr.io/{PROJECT_ID}/python2.7:debug": "//experimental/python2.7:debug_debian9",
