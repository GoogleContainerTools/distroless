...
container_bundle(
    ...
    images = {
        ...
        "gcr.io/{PROJECT_ID}/base:debug-debian10": "//base:debug-debian10",
        "gcr.io/{PROJECT_ID}/base:debug-nonroot": "//base:debug-nonroot",
        "gcr.io/{PROJECT_ID}/base:debug-nonroot-debian10": "//base:debug-nonroot-debian10",
        "gcr.io/{PROJECT_ID}/base:latest": "//base:base",
        "gcr.io/{PROJECT_ID}/base:nonroot": "//base:base-nonroot",
        "gcr.io/{PROJECT_ID}/base:nonroot-debian10": "//base:base-nonroot-debian10",
        "gcr.io/{PROJECT_ID}/static:debian10": "//base:static-debian10",
        "gcr.io/{PROJECT_ID}/static:latest": "//base:static",
        "gcr.io/{PROJECT_ID}/static:nonroot": "//base:static-nonroot",
        "gcr.io/{PROJECT_ID}/static:nonroot-debian10": "//base:static-nonroot-debian10",
