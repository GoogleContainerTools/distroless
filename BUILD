...
container_bundle(
    ...
    images = {
        ...
        "gcr.io/{PROJECT_ID}/base:debug_debian10": "//base:debug_debian10",
        "gcr.io/{PROJECT_ID}/base:debug-nonroot": "//base:debug-nonroot",
        "gcr.io/{PROJECT_ID}/base:debug-nonroot_debian10": "//base:debug-nonroot_debian10",
        "gcr.io/{PROJECT_ID}/base:latest": "//base:base",
        "gcr.io/{PROJECT_ID}/base:nonroot": "//base:base-nonroot",
        "gcr.io/{PROJECT_ID}/base:nonroot_debian10": "//base:base-nonroot_debian10",
