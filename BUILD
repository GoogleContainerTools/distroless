...
NODEJS = {
    ...
    "{REGISTRY}/{PROJECT_ID}/nodejs:10": "//nodejs:nodejs10_amd64_debian10",
    ...
    "{REGISTRY}/{PROJECT_ID}/nodejs:10-debug": "//nodejs:nodejs10_debug_amd64_debian10",
    ...
    "{REGISTRY}/{PROJECT_ID}/nodejs-debian10:10": "//nodejs:nodejs10_amd64_debian10",
    ...
    "{REGISTRY}/{PROJECT_ID}/nodejs-debian10:10-debug": "//nodejs:nodejs10_debug_amd64_debian10",
