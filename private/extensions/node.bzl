...
def _node_impl(module_ctx):
    ...
    node_archive(
        name = "nodejs24_amd64",
        sha256 = "bbeb5fb8113b44fc30f5a5887dbc0ab66af8e56139f5f9fbe7c7a1aa056246dc",
        strip_prefix = "node-v24.3.0-linux-x64/",
        urls = ["https://nodejs.org/dist/v24.3.0/node-v24.3.0-linux-x64.tar.gz"],
        version = "24.3.0",
        architecture = "amd64",
        control = "//nodejs:control",
    )
    ...
    node_archive(
        name = "nodejs24_arm64",
        sha256 = "371fc060d5dd4de565586c3cc70034956db67a8f3dae0f0e5724fa56147c472a",
        strip_prefix = "node-v24.3.0-linux-arm64/",
        urls = ["https://nodejs.org/dist/v24.3.0/node-v24.3.0-linux-arm64.tar.gz"],
        version = "24.3.0",
        architecture = "arm64",
        control = "//nodejs:control",
    )
    ...
    node_archive(
        ...
        sha256 = "2f3979aa58e30b78205a319f2bcb4c21f849d1f4a31acb753c63a0508046e87f",
        strip_prefix = "node-v24.3.0-linux-ppc64le/",
        urls = ["https://nodejs.org/dist/v24.3.0/node-v24.3.0-linux-ppc64le.tar.gz"],
        version = "24.3.0",
        architecture = "ppc64le",
        control = "//nodejs:control",
    )
    ...
    node_archive(
        name = "nodejs24_s390x",
        sha256 = "bb5ca45bab065d7a23cdfda7e682b0aa6c64a3756c92bfc2bf13831731cd6324",
        strip_prefix = "node-v24.3.0-linux-s390x/",
        urls = ["https://nodejs.org/dist/v24.3.0/node-v24.3.0-linux-s390x.tar.gz"],
        version = "24.3.0",
        architecture = "s390x",
        control = "//nodejs:control",
    )
