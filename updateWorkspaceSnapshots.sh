...
bazel build @package_bundle_amd64_debian9//file:packages.bzl
bazel build @package_bundle_amd64_debian10//file:packages.bzl
bazel build @package_bundle_arm_debian9//file:packages.bzl
bazel build @package_bundle_arm_debian10//file:packages.bzl
bazel build @package_bundle_arm64_debian9//file:packages.bzl
bazel build @package_bundle_arm64_debian10//file:packages.bzl
bazel build @package_bundle_s390x_debian9//file:packages.bzl
bazel build @package_bundle_s390x_debian10//file:packages.bzl
bazel build @package_bundle_ppc64le_debian9//file:packages.bzl
