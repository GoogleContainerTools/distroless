...
load("@package_bundle_arm64_debian9//file:packages.bzl", packages_arm_debian9 = "packages")
load("@package_bundle_arm64_debian10//file:packages.bzl", packages_arm_debian10 = "packages")
