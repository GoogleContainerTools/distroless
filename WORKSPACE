...
http_archive(
    ...
    build_file = "//experimental/dotnet_core_aspnet:BUILD.dotnet_core_aspnet",
...
http_archive(
    ...
    build_file = "//experimental/dotnet_core_runtime:BUILD.dotnet_core_runtime",
...
http_archive(
    ...
    build_file = "//experimental/dotnet_core_sdk:BUILD.dotnet_core_sdk",
